<?php
  $title = "ORS | Business Relocation | Business Moves | Office Removals
  ";
  $currentPage = "home";
 ...
 ?>
  ...
  <body>
        ...
        <div class="hse">
          <div class="carousel slide carousel-fade" id="myCarousel" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item carousel-image-1 active" title="ORS-img">
                  <div class="container">
                ...
                <div class="carousel-item carousel-image-2" title="ORS-img">
                  <div class="container">
                ...
                <div class="carousel-item carousel-image-3" title="ORS-img">
                  <div class="container">
        ...
        <div class="container">
          <div class="site-welcome py-3">
            ...
            <p class="info-text-font">
              ...
              business productive. That is why we have developed a fast strategy including
      ...
      <section id="catalogue" class="p-4 text-white">
        ...
        <div data-paperturn="embed-v1" style="width: 100%; max-width: 100%; height: 408px; z-index: 1">
        <iframe src="https://www.paperturn-view.com/?pid=NTI52437&bgcolor=%23FFFFFF&embed=script&shadow=1&flipSound=1&hardCover="
          width="100%" height="100%" webkitallowfullscreen mozallowfullscreen allowfullscreen style="border: 0px; display: block;
          background-color: #ffffff"></iframe>
        </div>
        <script src="https://www.paperturn-view.com/script/embed?v=1">
        </script>
      </section>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <header class="showcase-circle sc-1" title="ORS-img">
            ...
            <!-- CARD-2 -->
            <div class="col-lg-3 col-md-6">
            <header class="showcase-circle sc-2" title="ORS-img">
                  <div class="container showcase-circle-inner ">
                    <h1>Clearance</h1>
                    <p>
            ...
            <!-- CARD-3 -->
            <div class="col-lg-3 col-md-6">
              <header class="showcase-circle sc-3" title="ORS-img">
                  <div class="container showcase-circle-inner ">
            ...
            <!-- CARD-4 -->
            <div class="col-lg-3 col-md-6">
            <header class="showcase-circle sc-4" title="ORS-img">
                  <div class="container showcase-circle-inner ">
                    <h1>Dilapidation</h1>
                    <p>
      ...
      <!-- WHY SECTION -->
      <section id="why-section" title="ORS-img">
        <div class="why-image">
          <div class="container">
            <div class="row">
              <div class="col-md-6">
