             ...
             <div class="col-md-10">
               <div class="container moving-boxes">
                 ...
                 <ul type="square" class="info-text-font">
                   <br>
                   <li>
                     <span class="sec-head">Call us</span> - For a free quote
                   </li>
                   <br>
                   <br>
                   <li>
                     <span class="sec-head">Deliver</span> - Deliveries at a pre-arranged dates and times
                   </li>
                   <br>
                   <br>
                   <li>
                     <span class="sec-head">Use</span> - Labels and security seals provide if required
                   </li>
                   <br>
                   <br>
                   <li>
