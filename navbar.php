...
>
  <div class="container">
    <div class="navbar-brand">
      <a href="index.php" id="ors_brand_collapse"
        ><img src="img/logo_original.png" alt="Office Relocation Services" />Office Relocation
        Services</a
      >
    </div>
    <button
      ...
      <ul class="navbar-nav">
        ...
        <li <?php if ($currentPage === 'rel-office' || $currentPage === 'rel-lib' || $currentPage === 'rel-IT'
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a <?php if ($currentPage === 'rel-office') {echo 'class="dropdown-item active"';} ?> href="relocation-office.php" class="dropdown-item">
              Office Reloctions
            </a>
            <a <?php if ($currentPage === 'rel-lib') {echo 'class="dropdown-item active"';} ?> href="relocation-library.php" class="dropdown-item">
              Library Relocations
            </a>
            <a <?php if ($currentPage === 'rel-IT') {echo 'class="dropdown-item active"';} ?> href="relocation-IT.php" class="dropdown-item">
              IT Reloctions
            </a>
            <a <?php if ($currentPage === 'rel-warehouse') {echo 'class="dropdown-item active"';} ?> href="relocation-warehouse.php" class="dropdown-item">
